# FUTURE FOODS SFS INDICATORS DATA MODEL 

The aim is to establish a harmonised data model for structured collection of metadata on sustainable food systems (SFS) indicators.
