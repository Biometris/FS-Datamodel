...
file_path = 'src/schema/food_system_indicators.yaml'
...
def generate_viz_json():
    ...
    with open('src/docs/files/treats_dagre.json', 'w') as json_file:
    ...
    with open('src/docs/files/predicates.json', 'w') as json_file:
        json.dump(pred_data, json_file, indent=4)

    with open('src/docs/files/qualifiers.json', 'w') as json_file:
        json.dump(qualifier_data, json_file, indent=4)

    with open('src/docs/files/categories.json', 'w') as json_file:
        json.dump(cat_data, json_file, indent=4)

    with open('src/docs/files/associations.json', 'w') as json_file:
